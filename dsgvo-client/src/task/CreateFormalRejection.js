...
class CreateFormalRejection extends Component {
    ...
    render() {
        return <div className="task-form">
            ...
            <Message
                type="info"
                description="Bitte verfassen Sie eine manuelle Absage, da die Identität nicht bestätigt werden konnte."
            />
            <h2>Personendaten</h2>
            <ul>
...
export default withRouter(CreateFormalRejection)